...
<xsl:stylesheet version="1.0"
                                            ...
                                            <xsl:if test="string-length($comparedate) > 0">
                                                <span>
                                                    ...
                                                    <xsl:call-template name="getLocalizedString">
                                                        ...
                                                        <xsl:with-param name="key" select="'år'"/>
                                                        <xsl:with-param name="post" select="')'"/>
                                                    </xsl:call-template>
                                                </span>
                                            </xsl:if>
    ...
    <xsl:template name="caseUp">
        <xsl:param name="data"/>
        <xsl:if test="$data">
            <xsl:value-of select="translate($data,$lc, $lc)"/>
        </xsl:if>
    </xsl:template>
        ...
        <xsl:if test="count(hl7:component/hl7:structuredBody/hl7:component[hl7:section]) &gt; 0">
            <td style="background-color: white;">
                ...
                <div id="sectionsToggleExpand" style="display: none;" class="span_button" onclick="expandAllSections();">
                    <xsl:call-template name="getLocalizedString">
                        <xsl:with-param name="key" select="'Udfold alle'"/>
                    </xsl:call-template>
                </div>
                <div id="sectionsToggleCollapse" class="span_button" onclick="collapseAllSections();">
                    <xsl:call-template name="getLocalizedString">
                        <xsl:with-param name="key" select="'Sammenklap alle'"/>
                    </xsl:call-template>
                </div>
            </td>
        </xsl:if>
                ...
                <ul id="{$tocid}">
                    <li style="list-style: none;">
                        <div class="span_button">
                            <xsl:call-template name="getLocalizedString">
								<xsl:with-param name="key" select="'Indholdsfortegnelse'"/>
                            </xsl:call-template>
                            <xsl:text>&#160;&#8711;</xsl:text>
                        </div>
                        <ul>
